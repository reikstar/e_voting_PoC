...
class ElGamalBase:
    ...
    def generate_params(
        self, group_params: Optional[Tuple[int, int]] = None
    ) -> None: ...
    def _validate_and_set_params(self, group_params: Tuple[int, int]) -> None: ...
    def re_encrypt(
        self, ciphertext: Tuple[int, int], rnd_value: int, key: int
    ) -> Tuple[int, int]: ...
    def homomorphic_mul(
        self, ciphertext_a: Tuple[int, int], ciphertext_b: Tuple[int, int]
    ) -> Tuple[int, int]: ...
    @property
...
class AddElGamal(ElGamalBase):
    ...
    def __init__(self, bits: int, predefined_group: bool = False) -> None: ...
    def generate_params(
        self, group_params: Optional[Tuple[int, int, int]] = None
    ) -> None: ...
